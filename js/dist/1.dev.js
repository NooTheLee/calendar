...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function slide_loading(btn, effect) {
    ...
    status = 'dangChuyenDong'; // Loai bo tat ca class truoc khi them class moi
    ...
    if (btn == "nut trai") {
      ...
      stt[id_pre].classList.add('active'); //Chi dung 1 event khi ket thuc vi class return co thoi gian chuyen dong lau nhat
      ...
      stt[id_next].classList.add('active'); //Chi dung 1 event khi ket thuc vi class return co thoi gian chuyen dong lau nhat
